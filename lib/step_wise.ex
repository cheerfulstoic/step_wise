defmodule StepWise do
  defmodule Error do
    @moduledoc "For errors generated by StepWise itself"
  ...
  defmodule StepFunctionError do
    @moduledoc """
      ...
      When `Exception.message/1` is used, the original error will be returned, prefixed
      by a line from `StepWise` showing:
